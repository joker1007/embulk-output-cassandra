...
public class TestCassandraOutputPlugin {
  ...
  @Rule public CassandraContainer<?> cassandra = new CassandraContainer<>("cassandra:4.0");
  ...
  private List<String> getCassandraHostAsList() {
    return Collections.singletonList(cassandra.getHost());
  }
  ...
  public void testUuid() throws IOException {
    ...
    assertTrue(
        Uuids.unixTimestamp(row1.getUuid("timeuuid_item"))
  ...
  private Instant createInstant(
      int year, int month, int day, int hour, int min, int sec, int nsec) {
