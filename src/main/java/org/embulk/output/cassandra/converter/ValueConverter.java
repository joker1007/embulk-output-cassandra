...
public class ValueConverter
{
    ...
    public static GenericType<?> buildGenericTypeFromDataType(DataType dataType) {
        if (dataType instanceof PrimitiveType) {
            ...
            return GenericType.mapOf(buildGenericTypeFromDataType(mapType.getKeyType()), buildGenericTypeFromDataType(mapType.getValueType()));
    ...
    {
        if (!dataType.equals(DataTypes.UUID) && !dataType.equals(DataTypes.TIMEUUID) && value.isJsonNull()) {
            return null;
        }
        ...
        if (dataType instanceof ListType) {
            ...
            value.asJsonObject().forEach((k, v) -> result.put(
